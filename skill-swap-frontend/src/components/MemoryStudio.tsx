          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="rounded-md border border-border p-2 flex flex-wrap gap-2">
                ...
                <Button variant="ghost" size="sm" onClick={() => insertAroundSelection('[', '](https://www.youtube.com/watch?v=)', 'Video Title')} title="Insert YouTube Video" disabled={editorActionsDisabled}><Video className="w-4 h-4" /></Button>
                <Button variant="ghost" size="sm" onClick={() => insertAroundSelection('[', '](https://www.instagram.com/reel/)', 'Instagram Post')} title="Insert Instagram Post" disabled={editorActionsDisabled}><Instagram className="w-4 h-4" /></Button>
                <Button
                  variant="ghost"
                  size="sm"
                        ...
                        components={{
                          ...
                          a: ({ href, children, ...props }) => {
                            ...
                            if (ytMatch && ytMatch[1]) {
                              ...
                              return (
                                <div className="my-4 aspect-video w-full rounded-xl overflow-hidden shadow-lg border border-border/60 bg-muted">
                                  <iframe
                                    width="100%"
                                    height="100%"
                            ...
                            if (igMatch && igMatch[0]) {
                              return (
                                <div className="my-4 w-full max-w-[400px] mx-auto overflow-hidden rounded-xl border border-border/60 bg-muted">
                                  <iframe
