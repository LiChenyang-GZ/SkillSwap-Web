...
export const DASHBOARD_AVATAR_UNSUPPORTED_MESSAGE = "Unsupported image format. Please use PNG/JPG/WEBP/GIF/SVG.";
export const DASHBOARD_AVATAR_TOO_LARGE_MESSAGE = "Image size must be 10MB or smaller.";
