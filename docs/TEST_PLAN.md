...
- 2026-05-28: Added frontend CI workflow (.github/workflows/frontend-ci.yml) for PR/push changes affecting skill-swap-frontend/** or the workflow file itself; current frontend package scripts expose build only.
